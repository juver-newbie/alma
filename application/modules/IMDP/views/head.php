...
<head>
  ...
  <title><?php echo $this->nativesession->get("page"); ?> | Home | Management System for Modules, FLMS, and Creative Works at IMDP Center of SLSU-Tomas Oppus</title>
...
<body onload="message();">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo base_url(); ?>IMDP" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            ?>
                <li class="message-item">
                  <a href="<?php echo base_url(); ?>IMDP/messages?username=<?php echo $admin->username; ?>">
                    <img src="<?php echo base_url(); ?>assets/uploads/profile/<?php echo $admin->profile; ?>" class="rounded-circle">
                    <div>
                      <label><?php echo $admin->first." ".$admin->middle." ".$admin->last; ?></label>
                      <!-- <p>0 Messages</p> -->
                    </div>
                  </a>
                </li>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?php echo base_url(); ?>assets/superadmin/img/profile-img.jpg" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo substr($superadmin->first,0,1).". ".$superadmin->last; ?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo $superadmin->first.' '.$superadmin->middle.' '.$superadmin->last; ?></h6>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="<?php echo base_url(); ?>IMDP/logout">
  ...
  <div class="modal fade" id="addMaterial" tabindex="-1">
    <div class="modal-dialog">
      <form action="<?php echo base_url(); ?>superadmin/addMaterial" method="post" enctype='multipart/form-data'>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="card mb-3">
            <div class="row g-0">
              <div class="col-md-4">
                <img src="<?php echo base_url(); ?>assets/developers/team-1.jpg" class="img-fluid rounded-start" alt="...">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title">First Middle Last</h5>
                  <p class="card-text"><i class="bi bi-pin-map"></i>&ensp;Poblacion, Bontoc, Southern Leyte<br><i class="bi bi-envelope"></i>&ensp;<a href="mailto:sample@email.com">sample@email.com</a><br><i class="bi bi-telephone"></i>&ensp;0912345689</p>
                </div>
              </div>
            </div>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo $navlink['a']; ?>" href="home">
          <i class="bi bi-person"></i>
          <span>Administrators</span>
        </a>
      </li><!-- End Dashboard Nav -->
      <li class="nav-item">
        <a class="nav-link <?php echo $navlink['b']; ?>" href="materials">
          <i class="bi bi-menu-button-wide"></i><span>Materials</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php echo $navlink['c']; ?>" href="requests">
          <i class="bi bi-bookmark"></i><span>Requests</span>
        </a>
      </li>
      <!-- <li class="nav-item">
        <a class="nav-link <?php echo $navlink['d']; ?>" href="messages">
          <i class="bi bi-envelope"></i><span>Messages</span>
        </a>
      </li> -->
      <li class="nav-item">
        <a class="nav-link <?php echo $navlink['e']; ?>" href="categories">
          <i class="bi bi-list-task"></i><span>Categories</span>
        </a>
  ...
  <script type='text/javascript'>
          ...
          setInterval(function(){
            $(document).ready(function(){
                $.ajax({
                    url:'<?php echo base_url(); ?>index.php/IMDP/getUnread',
                    method: 'post',
                    data: {status: '1'},
                    dataType: 'json',
