...
<head>
  ...
  <title>SuperAdmin | Management System for Modules, FLMS, and Creative Works at IMDP Center of SLSU-Tomas Oppus</title>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-12 col-md-12 d-flex flex-column align-items-center" style="margin-bottom: 10px; text-align: center">
              ...
              <h5><b>MANAGEMENT SYSTEM FOR MODULES, FLMS AND CREATIVE WORKS AT IMDP CENTER OF SLSU-TOMAS OPPUS</b></h5>
            </div>
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">IMDP Head</h5>
                    <p class="text-center small">Enter your username & password to login</p>
                  </div>

                  <form class="row g-3" action="<?php echo base_url(); ?>imdp/entry" method="post">
