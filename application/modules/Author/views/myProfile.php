                  ...
                  <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                    ...
                    <div class="tab-pane fade" id="bordered-justified-contact" role="tabpanel" aria-labelledby="contact-tab">
                      <?php
                        ...
                        {
                      ?>
                        <p class="b-b-d"><?php echo $log->s_title.' | ('.$log->a_date.','.$log->a_time.') '.$log->activity;  ?></p>
                      <?php
                        }
                      ?>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="row g-3" action="<?php echo base_url(); ?>author/updateAuthor" method="post" enctype="multipart/form-data">
            <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-floating">
                <input type="text" class="form-control" name="id" id="id" placeholder="ID Number" value="<?php echo $admin->a_id; ?>" readonly>
